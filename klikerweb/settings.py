"""
Django settings for klikerweb project.
...
#SECRET_KEY = '-4)%yizej+j5&=rokx+4zpj_lweaxm1lo^b1=fk+1x$c$pf+7)'
...
INSTALLED_APPS = [
'klikerwebapp.apps.KlikerwebappConfig',
...
WSGI_APPLICATION = 'klikerweb.wsgi.application'
